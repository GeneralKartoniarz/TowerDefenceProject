...
//W RAZIE NIEJASNOSCI ZOBACZ PLIKI INNYCH WIEZ I ABSTRAKCYJNA KLASE TOWER.H
//CELEM UMIESZCZENIA WIEZYCZKI WYSZUKAJ W PLIKU GAMESTATE.CPP "MOD"
// 
//MODTEMPLATE::MODTEMPLATE(sf::Vector2f position) : shootSound(shootBuffer)
//{
//    // £adowanie zasobów graficznych
//    LoadTexture("assets/MODTEMPLTE/" + path + to_string(level) + ".png");
//    // Konfiguracja parametrów bojowych i ekonomicznych
//    tCost = COST;
//    tAttack = 25.f;
//    tRange = 200.f;
//    tName = "MODTEMPLTE Tower";
//    // Ustawienie mechaniki szybkostrzelnoœci
//    attackCooldown = 0.4f;
//    attackTimer = 0.f;
//    if (!shootBuffer.loadFromFile("assets/sfx/MODTEMPLTE.wav"))
//        cout << "c";
...
//void MODTEMPLATE::Update(float dt, vector<unique_ptr<Monster>>& monsters, vector<unique_ptr<Bullet>>& bullets)
//{
//    LoadTexture("assets/MODTEMPLATE/" + path + to_string(level) + ".png");
...
//void MODTEMPLATE::Draw(sf::RenderWindow& window)
//{
